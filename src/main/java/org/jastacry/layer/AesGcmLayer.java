 ...
 */
public class AesGcmLayer extends AbstractCipherLayer
{
    /**
     * static name of the layer.
     */
    static final String LAYERNAME = "AES GCM Layer";

    /**
     * Used algorithm name.
     */
    private static final String MYALG = "AES/GCM/PKCS5Padding";
    ...
    public AesGcmLayer()
    {
        super(AesGcmLayer.class, LAYERNAME);
    }
    ...
    public boolean equals(final Object o)
    {
        ...
        if (!(o instanceof AesGcmLayer))
        {
            return false;
        }

        final AesGcmLayer layer = (AesGcmLayer) o;
